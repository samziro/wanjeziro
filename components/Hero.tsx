    ...
    <section className="relative min-h-screen flex flex-col justify-end pb-20 pt-32 px-6 overflow-hidden bg-[var(--cream)]">
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <div className="overflow-hidden mb-6">
          <h1
            className="font-display text-5xl md:text-7xl lg:text-8xl font-medium leading-[1.05] animate-fade-up"
            style={{ animationDelay: '0.2s' }}
          >
            Turning online
            <br />
            <em className="not-italic text-[var(--forest)]">presence</em> into
            <br />
            customers.
          </h1>
        </div>
        ...
        >
          <p className="text-base md:text-lg font-light text-[var(--ink)] opacity-70 max-w-md leading-relaxed">
            I help SMEs move from random digital activity to structured growth
            through websites, marketing systems, and conversion strategy.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="#contact"
              className="group flex items-center gap-2 px-7 py-4 bg-[var(--ink)] text-[var(--cream)] text-sm font-medium hover:bg-[var(--forest)] transition-colors duration-300"
            >
            ...
            <a
              href="#work"
              className="flex items-center gap-2 px-7 py-4 border border-[var(--sand)] text-sm font-medium text-[var(--ink)] hover:border-[var(--ink)] transition-colors duration-300"
            >
              View case studies
            </a>
          </div>
        ...
        {/* Stats row */}
        <div
          className="mt-16 pt-10 border-t border-[var(--sand)] grid grid-cols-3 gap-6 animate-fade-up"
        ...
        >
          {[
            ...
            <div key={stat.label}>
              <p className="font-display text-3xl md:text-4xl font-medium text-[var(--ink)]">
                {stat.value}
              </p>
              <p className="text-xs font-light text-[var(--ink)] opacity-50 mt-1">
                {stat.label}
              </p>
            </div>
          ))}
