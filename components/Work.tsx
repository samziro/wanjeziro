...
const projects = [
  ...
  { client: 'Chef Joshua Brand', category: 'Growth System', year: '2023', problem: 'High social media engagement but almost no conversion to actual bookings or enquiries from their content.', solution: 'Built a complete lead capture funnel from social content to WhatsApp booking system.', results: ['Enquiry-to-booking rate improved by 60%','Automated follow-up reduced manual work','Consistent monthly booking pipeline'] },
]
