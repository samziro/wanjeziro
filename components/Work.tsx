...
const projects = [
  ...
  { client: 'Fit Hunter', category: 'Marketing Strategy', year: '2025', problem: 'Businesses were spending on ads with no clear targeting strategy, wasting budget without measurable return.', solution: 'Designed a structured digital marketing strategy with audience profiling, channel selection, and a 90-day execution roadmap.', results: ['40% reduction in wasted ad spend','Clear content calendar and messaging','Measurable KPIs for the first time'] },
  { client: 'Chef Joshua', category: 'Growth System', year: '2024', problem: 'High social media engagement but almost no conversion to actual bookings or enquiries from their content.', solution: 'Built a complete lead capture funnel from social content to WhatsApp booking system.', results: ['Enquiry-to-booking rate improved by 60%','Automated follow-up reduced manual work','Consistent monthly booking pipeline'] },
]
