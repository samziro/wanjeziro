...
// Replace with Wanje's real WhatsApp number (country code, no + or spaces)
const WHATSAPP_NUMBER = '254769751566'
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hi Wanje! I visited your website and I'd like to talk about growing my business digitally."
)
  ...
  return (
    <div className="fixed bottom-24 left-6 z-50 flex flex-col items-start gap-2">
      ...
      <a
        ...
        onClick={() => setTooltip(false)}
        className="group w-14 h-14 flex items-center justify-center shadow-xl hover:scale-105 transition-transform duration-300"
      ...
      >
        ...
        {/* Pulse ring */}
        <span
          className="absolute w-14 h-14 animate-ping opacity-30"
          style={{ background: '#25D366', borderRadius: '2px' }}
        />
      </a>
    </div>
